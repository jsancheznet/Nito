...
b32 KeyIsPressed(keyboard *Keyboard, SDL_Scancode Scancode)
{
    return Keyboard->State[Scancode];
}

b32 KeyIsNotPressed(keyboard *Keyboard, SDL_Scancode Scancode)
{
    return !Keyboard->State[Scancode];
}

b32 KeyWasNotPressed(keyboard *Keyboard, SDL_Scancode Scancode)
{
    return !Keyboard->PrevState[Scancode];
}

b32 KeyIsReleased(keyboard *Keyboard, SDL_Scancode Scancode)
{
